...
import { getCurrentAccount, getPreference, setPreference } from './utils.js';
                ...
                <div class="absolute bottom-3 left-3 right-3 flex justify-between items-end">
                    <div>
                        ...
                        <p class="text-gray-200 text-xs flex items-center gap-1.5 font-medium location-text">
                            <i class="fas fa-map-marker-alt text-brand-blue text-xs"></i> ${hostel.location}
                        </p>
                    </div>
                </div>
            </div>
...
async function handleCheckout() {
    ...
    setTimeout(() => {
        window.location.href = '../general/receipt.html';
    }, 800);
}
